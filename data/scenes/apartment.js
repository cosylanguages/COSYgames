(function() {
    ...
    window.COSY_SCENE_DATA['apartment'] = {
        ...
        svgBackground: `
            ...
            <!-- Layer 1: Background (Wall, Floor, Window, Painting, Doorways) -->
            ...
            <!-- Layer 2: Midground (Bookshelf, Rug, TV, Plant) -->
            ...
            <!-- Layer 3: Foreground (Sofa, Armchair, Coffee Table, Floor Lamp) -->
